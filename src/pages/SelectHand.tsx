...
function SelectHand() {
  ...
  return (
    <div className={`flex flex-col h-[100vh] bg-[#ffe090] 
    ${
      isMouseOver ?"": "bg-[url('/Screenshot_2023-02-08_at_07-07-59_Fingerspelling_with_Machine_Learning-removebg-preview(1).png')]"
    }
